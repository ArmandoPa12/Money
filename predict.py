...
model_path = os.path.join(save_dir, 'billetes_model_transfer_learning.keras')
model = tf.keras.models.load_model(model_path)

# Ruta de la imagen a predecir
#img_path = os.path.join(project_dir, 'data', '200', 'wq (192).jpg')  # Cambia esto a la ruta de tu imagen
