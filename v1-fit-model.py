...
# Comprobar si se está usando GPU
print("¿TensorFlow está usando GPU?")
print(tf.test.is_gpu_available())  # Deprecated, use the next line instead.
...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(5, activation='softmax')  # 3 clases: 10, 20, 100
])
